...
import 'package:education_app/src/course/features/exams/presentation/widget/exam_navigation_blob.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:provider/provider.dart';

class ExamViews extends StatefulWidget {
  const ExamViews({super.key});

  static const routeName = '/exam-view';

  @override
  State<ExamViews> createState() => _ExamViewsState();
}

class _ExamViewsState extends State<ExamViews> {
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (_, index) {
                                ...
                                return RadioListTile(
                                  ...
                                  groupValue: controller.userChoice?.userChoice,
                                  title: Text(
                                    '${choice.identifier}. '
                                    '${choice.choiceAnswer}',
                                    style: const TextStyle(
