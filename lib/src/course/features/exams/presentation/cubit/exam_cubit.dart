...
class ExamCubit extends Cubit<ExamState> {
  ExamCubit({
    required GetExamsQuestions getExamsQuestions,
  ...
  })  : _getExamsQuestions = getExamsQuestions,
        _getExams = getExams,
  ...
  final GetExamsQuestions _getExamsQuestions;
  ...
  Future<void> getExamQuestions(Exam exam) async {
    ...
    final result = await _getExamsQuestions(exam);
    result.fold(
