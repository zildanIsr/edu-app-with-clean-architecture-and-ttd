...
class ExamQuestionModel extends ExamQuestion {
  ...
  const ExamQuestionModel.empty()
      : this(
          ...
          examId: '_exam.examId',
          questionText: '_exam.questionText',
          choices: const [],
          correctAnswer: '_exam.correcAnswer',
        );

  factory ExamQuestionModel.fromMap(DataMap map) => ExamQuestionModel(
        id: map['id'] as String,
  ...
  factory ExamQuestionModel.fromUploadMap(DataMap map) => ExamQuestionModel(
        id: map['id'] as String? ?? '',
        examId: map['examId'] as String? ?? '',
        courseId: map['courseId'] as String? ?? '',
