...
class ExamHistoryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final answerdQuestionsPercentage =
        exam.answers.length / exam.totalQuestions;
    return GestureDetector(
      behavior: HitTestBehavior.opaque,
      onTap: navigateToDetails
          ? () => Navigator.of(context)
              .pushNamed(ExamHistoryDetailScreen.routeName, arguments: exam)
          : null,
      child: Row(
        children: [
          Container(
                ...
                RichText(
                  text: TextSpan(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
                      color: answerdQuestionsPercentage < .5
                          ? Colours.redColour
                          : Colours.greenColour,
                    ),
                    children: const [
          ...
          CircularStepProgressIndicator(
            ...
            selectedColor: answerdQuestionsPercentage < .5
                ? Colours.redColour
                : Colours.greenColour,
            padding: 0,
            width: 60,
            ...
            child: Center(
              child: Text(
                '${(answerdQuestionsPercentage * 100).toInt()}',
                style: TextStyle(
                  fontSize: 12,
