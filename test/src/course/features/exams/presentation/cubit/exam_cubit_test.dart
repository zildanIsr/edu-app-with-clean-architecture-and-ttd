...
class MockGetExamQuestions extends Mock implements GetExamsQuestions {}
...
void main() {
  ...
  setUp(() {
    ...
    cubit = ExamCubit(
      getExamsQuestions: getExamQuestions,
  ...
  test('initial state should be [ExamInitial]', () {
    expect(cubit.state, ExamInitial());
  });

  final tFailure = APIFailure(message: 'Server Failure', statusCode: '500');
