  ...
  group('ExamModel', () {
    ...
    group('fromMap', () {
      test('should return a valid [ExamModel] when the JSON is not null',
          () async {
        final map = jsonDecode(fixtures('exam.json')) as DataMap;
    ...
    group('fromUploadMap', () {
      test('should return a valid [ExamModel] when the JSON is not null',
          () async {
        final map = jsonDecode(fixtures('uploaded_exam.json')) as DataMap;
    ...
    group('fromJSON', () {
      test('should return a valid [ExamModel] when the JSON is not null',
          () async {
        final json = fixtures('uploaded_exam.json');
    ...
    group('copyWith', () {
      test('should return a new [ExamModel] with the same values', () async {
        final map = tExamModel.copyWith(id: '');
